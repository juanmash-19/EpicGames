...
import { View, Text, ScrollView, StyleSheet, TouchableOpacity, TextInput, Alert,KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard } from "react-native";
...
const UsersScreen = () => {
  ...
  const handleCreateOrUpdate = async () => {
    if (
      ...
      Alert.alert("Error", "Todos los campos son obligatorios y no pueden estar vacíos.");
      return;
    }
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          ...
          <View style={styles.form}>
            <Text style={styles.formHeader}>{editingUser ? "Editar Usuario" : "Crear Usuario"}</Text>
            <TextInput
              style={styles.input}
              placeholder="Nombre"
            ...
            <TouchableOpacity style={styles.saveButton} onPress={handleCreateOrUpdate}>
              <Text style={styles.buttonText}>{editingUser ? "Actualizar" : "Crear"}</Text>
            </TouchableOpacity>
            {editingUser && (
              <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 26, fontWeight: "bold", color: "#f8f8f2", marginVertical: 20, textAlign: "center" },
  userCard: { backgroundColor: "#121212", padding: 20, borderRadius: 15, marginBottom: 15 },
  ...
  noUsers: { fontSize: 18, color: "#6272a4", textAlign: "center", marginTop: 30 },
  ...
  form: { backgroundColor: "#222", padding: 20, borderRadius: 10, marginTop: 20 },
  formHeader: { fontSize: 20, fontWeight: "bold", color: "#fff", marginBottom: 10 },
